...
$idEditarEscola = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
...
<form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
    ...
    <input type="hidden" name="idAlunoEditar" value="<?php echo $idEditarEscola; ?>">

    <div class="row">
        <div id="cadastro-aluno" class="col l10 m10 offset-l1">
            <?php
            if ($idEditarEscola != ""):
                $buscarEscola= new EscolaController();
                $dadosEscola = $buscarEscola->buscarEscola($idEditarEscola);
